        ...
        <div className="card p-4 sm:p-8 bg-card/50 backdrop-blur-xl border-primary/20">
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-lg p-3 sm:p-4 mb-6">
            ...
            <ul className="text-xs sm:text-sm text-secondary space-y-1">
              ...
              <li>• Verify student status later with Alt Auth</li>
            </ul>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 bg-input border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-colors text-sm sm:text-base ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 bg-input border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-colors text-sm sm:text-base ${
