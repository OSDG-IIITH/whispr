          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-2 border-primary/30 pl-4">
                ...
                <p className="text-sm text-secondary">
                  Since we don&apos;t store your email with your account,
                  account recovery is not possible. We recommend securely
                  storing your username and password. This is a trade-off for
                  complete anonymity.
                </p>
              </div>
