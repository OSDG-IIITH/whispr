// Create our own API call function using the same pattern as your existing api.ts
...
export const adminAPI = {
  ...
  banUser: async (userId: string, banRequest: BanUserRequest): Promise<{ message: string }> => {
  ...
  takeActionOnReport: async (reportId: string, action: AdminActionRequest): Promise<{ message: string }> => {
