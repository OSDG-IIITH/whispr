...
import { reviewAPI, voteAPI } from "@/lib/api";
...
export default function MyReviewsPage() {
    ...
    const transformedReviews = reviews.map(review => transformReview(review, userVotes));
    ...
    const filteredReviews = transformedReviews.filter(review => {
        ...
        if (searchQuery) {
            ...
            if (!content.includes(query) && !courseName.includes(query) && !professorName.includes(query)) {
                return false;
            }
        }
        ...
        <div className="min-h-screen bg-black pb-24">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                >
                    ...
                    <p className="text-secondary">Manage and view all your course and professor reviews</p>
                </motion.div>
