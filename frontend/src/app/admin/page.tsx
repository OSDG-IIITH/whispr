    ...
    <div className="min-h-screen bg-black p-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-secondary">Manage users, reports, and moderation</p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-card/50 backdrop-blur-xl border border-primary/20 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary">Banned Users</p>
          ...
          <div className="bg-card/50 backdrop-blur-xl border border-primary/20 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-secondary">Pending Reports</p>
          ...
          <div className="bg-card/50 backdrop-blur-xl border border-primary/20 rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.under_review_reports || 0}</p>
              </div>
